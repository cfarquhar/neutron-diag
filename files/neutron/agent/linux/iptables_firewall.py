...
class IptablesFirewallDriver(firewall.FirewallDriver):
    ...
    def update_security_group_members(self, sg_id, sg_members):
        ...
        LOG.info("cfarquhar: in update_security_group_members")
        LOG.info("cfarquhar: Update members of security group (%s)", sg_id)
        LOG.info("cfarquhar: sg_members = {}".format(sg_members))
