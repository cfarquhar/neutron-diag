...
class CommonAgentLoop(service.Service):
    ...
    def process_network_devices(self, device_info):
        ...
        LOG.info("cfarquhar: entered process_network_devices")
        LOG.info("cfarquhar: device timestamps: {}".format(device_info.get('timestamps')))
        LOG.info("cfarquhar: current devices: {}".format(set(device_info.get('current'))))
        LOG.info("cfarquhar: updated devices: {}".format(set(device_info.get('updated'))))
        LOG.info("cfarquhar: added devices: {}".format(set(device_info.get('added'))))
        LOG.info("cfarquhar: removed devices: {}".format(set(device_info.get('removed'))))
